...
<body class="antialiased">
  ...
  {{-- <nav class="relative container mx-auto p-6">
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-20">
        <!-- Logo -->
        <img src="{{ asset('assets/svg/logo.svg') }}" class="w-1/2 h-fit" />
        <!-- Left Menu -->
        <div class="hidden space-x-8 font-bold lg:flex">
          <a href="#" class="text-grayishViolet hover:text-veryDarkViolet">Features</a>
          <a href="#" class="text-grayishViolet hover:text-veryDarkViolet">Contributors</a>
        </div>
      </div>
      ...
      <div class="hidden items-center space-x-6 font-bold text-grayishViolet lg:flex">
        ...
        <a href="#" class="px-8 py-3 font-bold text-white bg-[#0F585B] rounded-full hover:opacity-70">Get
          Started</a>
      </div>
    ...
    <div id="menu" class="absolute hidden p-6 rounded-lg bg-darkViolet left-6 right-6 top-20 z-100">
      <div class="flex flex-col items-center justify-center w-full space-y-6 font-bold text-white rounded-sm">
        ...
        <a href="#" class="w-full py-3 text-center rounded-full bg-[#0F585B]">Get Started</a>
      </div>
    </div>
  </nav> --}}
  ...
  <nav class="container relative mx-auto p-6">
    ...
    <div class="flex items-center justify-between space-x-20 my-6">
      <!-- Logo -->
      <div class="z-30">
        <img src="{{ asset('assets/svg/logo.svg') }}" alt="" id="logo" class="w-full">
      </div>
      ...
      <div class="hidden items-center space-x-10 uppercase text-grayishBlue md:flex">
        ...
        <a href="#" class="px-8 py-3 text-white bg-[#0F585B] rounded-full hover:opacity-70">Get Started</a>
      </div>
